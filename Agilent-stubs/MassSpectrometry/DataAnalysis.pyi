...
from pyms_agilent.enums import FragmentationOpMode
from pyms_agilent.enums import FragmentationClass
...
class IBDAFileInformation:
    ...
    @property
    def AcquisitionTime(self) -> float: ...

    @AcquisitionTime.setter
    def AcquisitionTime(self, value: float): ...
    ...
    def GetDeviceName(self, devType: DeviceType) -> str: ...
    ...
    @property
    def IRMStatus(self) -> IRMStatus: ...

    @IRMStatus.setter
    def IRMStatus(self, value: IRMStatus): ...

    def IsMSDataPresent(self) -> bool: ...
    def IsNonMSDataPresent(self) -> bool: ...
    def IsStoredDataTypePresent(self, deviceNameOrdinalNumber: str, desiredType: StoredDataType) -> bool: ...
    def IsUVSignalPresent(self, devType: DeviceType, signalName: str, devName: str) -> bool: ...
    def IsUVSpectralDataPresent(self) -> bool: ...

    @property
    def MSScanFileInformation(self) -> IBDAMSScanFileInformation: ...

    @MSScanFileInformation.setter
    def MSScanFileInformation(self, value: IBDAMSScanFileInformation): ...

    @property
    def MeasurementType(self) -> MeasurementType: ...

    @MeasurementType.setter
    def MeasurementType(self, value: MeasurementType): ...
...
class IBDAChromData:
    ...
    @property
    def ChromatogramType(self) -> ChromType: ...
    ...
    def GetXAxisInfoChrom(self, xChromunit: Any, xChromvalueType: Any) -> Tuple[None, DataUnit, DataValueType]: ...
    def GetYAxisInfoChrom(self, yChromunit: Any, yChromvalueType: Any) -> Tuple[None, DataUnit, DataValueType]: ...
    ...
    @property
    def MSLevelInfo(self) -> MSLevel: ...

    @property
    def MSScanType(self) -> MSScanType: ...

    @property
    def MSStorageMode(self) -> MSStorageMode: ...
...
class IMsdrDataReader:
    ...
    @property
    def MSScanFileInformation(self) -> MSScanFileInformation: ...
...
class IBDAActuals:
    ...
    def GetActualValue(self, actualDisplayName: str, xArrayValues: List[float], yArrayValues: List[float]) -> Tuple[None, List[float], List[float]]: ...
...
class IBDAChromFilter:
    ...
    @property
    def ChromatogramSubType(self) -> ChromSubType: ...

    @ChromatogramSubType.setter
    def ChromatogramSubType(self, value: ChromSubType): ...

    @property
    def ChromatogramType(self) -> ChromType: ...

    @ChromatogramType.setter
    def ChromatogramType(self, value: ChromType): ...
    ...
    @property
    def DesiredMSStorageType(self) -> DesiredMSStorageType: ...

    @DesiredMSStorageType.setter
    def DesiredMSStorageType(self, value: DesiredMSStorageType): ...
    ...
    @property
    def MSLevelFilter(self) -> MSLevel: ...

    @MSLevelFilter.setter
    def MSLevelFilter(self, value: MSLevel): ...

    @property
    def MSScanTypeFilter(self) -> MSScanType: ...

    @MSScanTypeFilter.setter
    def MSScanTypeFilter(self, value: MSScanType): ...
...
class IBDASpecData:
    ...
    @property
    def SpectrumType(self) -> SpecType: ...
...
class IBDAMSScanFileInformation:
    ...
    def Contains(self, key: MSScanType) -> bool: ...
    ...
    @overload
    def GetMSScanTypeInformation(self, scanType: MSScanType) -> IBDAMSScanTypeInformation: ...
    ...
    def GetMSScanTypeInformation(
            self,
            scanType: MSScanType = ...,
            ) -> Union[IBDAMSScanTypeInformation, List[IBDAMSScanTypeInformation]]: ...

    @property
    def IonModes(self) -> IonizationMode: ...
    ...
    @property
    def ScanTypes(self) -> MSScanType: ...

    @property
    def ScanTypesInformationCount(self) -> int: ...

    @property
    def SpectraFormat(self) -> MSStorageMode: ...
...
class IBDAActualData:
    ...
    @property
    def DisplayEffectType(self) -> DisplayEffectType:  ...

    @DisplayEffectType.setter
    def DisplayEffectType(self, value: DisplayEffectType): ...
...
class IBDASpecFilter:
    ...
    @property
    def SpectrumSubType(self) -> SpecSubType: ...

    @SpectrumSubType.setter
    def SpectrumSubType(self, value: SpecSubType): ...

    @property
    def SpectrumType(self) -> SpecType: ...

    @SpectrumType.setter
    def SpectrumType(self, value: SpecType): ...
...
class IBDAMSScanTypeInformation:
    ...
    @property
    def IonPolarities(self) -> IonPolarity: ...
...
class IBDASampleData:
    ...
    @property
    def Category(self) -> SampleCategory: ...

    @Category.setter
    def Category(self, value: SampleCategory): ...
...
class INonmsDataReader:
    ...
    def GetSignalInfo(self, dev: IDeviceInfo, type: StoredDataType) -> List[ISignalInfo]: ...
...
class IBDASample:
    ...
    def __init__(self, *args, **kwargs) -> Any: ...
    def GetSampleCollection(self, Category: SampleCategory) -> List[IBDASampleData]: ...
...
class IImsFrameMethod:
    ...
    @property
    def DetectorGainMode(self) -> TofMsProcessingMode: ...

    @DetectorGainMode.setter
    def DetectorGainMode(self, value: TofMsProcessingMode): ...
    ...
    @property
    def FragEnergyMode(self) -> FragEnergyMode: ...

    @FragEnergyMode.setter
    def FragEnergyMode(self, value: FragEnergyMode): ...
    ...
    @property
    def FragOpMode(self) -> FragmentationOpMode: ...

    @FragOpMode.setter
    def FragOpMode(self, value: FragmentationOpMode): ...
    ...
    @property
    def FrameType(self) -> ImsFrameType: ...

    @FrameType.setter
    def FrameType(self, value: ImsFrameType): ...
    ...
    @property
    def ImsGateMode(self) -> ImsGateMode: ...

    @ImsGateMode.setter
    def ImsGateMode(self, value: ImsGateMode): ...
    ...
    @property
    def ImsMuxProcessing(self) -> ImsMuxProcessing: ...

    @ImsMuxProcessing.setter
    def ImsMuxProcessing(self, value: ImsMuxProcessing): ...
    ...
    @property
    def ImsTrapMode(self) -> ImsTrapMode: ...

    @ImsTrapMode.setter
    def ImsTrapMode(self, value: ImsTrapMode): ...
    ...
    @property
    def TfsStorageMode(self) -> MSStorageMode: ...

    @TfsStorageMode.setter
    def TfsStorageMode(self, value: MSStorageMode): ...
...
class IBDADataAccess:
    ...
    @property
    def DesiredMSStorageTypeToUse(self) -> DesiredMSStorageType: ...

    @DesiredMSStorageTypeToUse.setter
    def DesiredMSStorageTypeToUse(self, value: DesiredMSStorageType): ...

    @property
    def FileInformation(self) -> IBDAFileInformation: ...
...
class IBDASpecFilterIcp:
    ...
    @property
    def YDataValueType(self) -> DataValueType: ...

    @YDataValueType.setter
    def YDataValueType(self, value: DataValueType): ...
...
class IBDAReadSpectra:
    ...
    @overload
    def ReadSpectrum(self, spectrumRequest: IBDASpecFilter, startRange: IRange, endRange: IRange) -> List[IBDASpecData]: ...

    @overload
    def ReadSpectrum(self, rowIndex: int, MassUnits: bool) -> IBDASpecData: ...

    @overload
    def ReadSpectrum(self, rowIndex: int, MassUnits: bool, desiredStorageMode: DesiredMSStorageType) -> IBDASpecData: ...

    def ReadSpectrum(self, *args, **kwargs) -> IBDASpecData: ...
...
class IBDAPeakSpecFilter:
    ...
    @property
    def BackgroundSource(self) -> ApseBackgroundSource: ...

    @BackgroundSource.setter
    def BackgroundSource(self, value: ApseBackgroundSource): ...
...
class IImsFrameRecord:
    ...
    @property
    def FragClass(self) -> FragmentationClass: ...

    @FragClass.setter
    def FragClass(self, value: FragmentationClass): ...
...
class ImsFrameScanRec:
    ...
    @property
    def DetectorGain(self) -> IonDetectorGain: ...

    @DetectorGain.setter
    def DetectorGain(self, value: IonDetectorGain): ...
...
class FrameData:
    ...
    @overload
    def AddTfsProfileSpectrum(self, basePeakAbund: float, basePeakMz: float, metrics: Any, encodedArray: List[Any]): ...

    def AddTfsProfileSpectrum(self, *args, **kwargs) -> List[Any]: ...
...
class _PointValueFormat:
    ...
    @property
    def DataType(self) -> DataFileValueDataType: ...

    @DataType.setter
    def DataType(self, value: DataFileValueDataType): ...
    ...
    @property
    def StorageScheme(self) -> PointValueStorageScheme: ...

    @StorageScheme.setter
    def StorageScheme(self, value: PointValueStorageScheme): ...

    @property
    def Type(self) -> DataValueType: ...

    @Type.setter
    def Type(self, value: DataValueType): ...
