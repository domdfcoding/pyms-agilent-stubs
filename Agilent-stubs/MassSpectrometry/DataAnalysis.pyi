...
class IBDAFileInformation:
    ...
    def IsUVSignalPresent(self, _: DeviceType, __: str, ___: str) -> bool: ...
...
class IBDAChromData:
    ...
    def GetXAxisInfoChrom(self, _: DataUnit, __: DataValueType) -> None: ...

    def GetYAxisInfoChrom(self, _: DataUnit, __: DataValueType) -> None: ...
...
class BDAChromData:
    ...
    def GetXAxisInfo(self, _: DataUnit, __: DataValueType) -> None: ...

    def GetYAxisInfo(self, _: DataUnit, __: DataValueType, ___: str) -> None: ...
...
class IMsdrDataReader:
    ...
    def Deisotope(self, _: IBDASpecData, __: IMsdrChargeStateAssignmentFilter) -> None: ...
    ...
    def GetBPC(self,
            ...
            ___: MSScanType,
            ____: IonPolarity,
            _____: IonizationMode,
            ) -> IBDAChromData: ...

    def GetChromatogram(self, _: IBDAChromFilter) -> List[IBDAChromData]: ...
    ...
    def GetScanRecord(self, _: int) -> IMSScanRecord: ...
    ...
    def OpenDataFile(self, _: str) -> bool: ...
...
class IBDASpecData:
    ...
    def GetPrecursorCharge(self, _: int) -> bool: ...

    def GetPrecursorIntensity(self, _: float) -> bool: ...

    def GetPrecursorIon(self, _: int) -> List[float]: ...

    def GetXAxisInfoSpec(self, _: DataUnit, __: DataValueType) -> None: ...

    def GetYAxisInfoSpec(self, _: DataUnit, __: DataValueType) -> None: ...
...
class BDASpecData:
    ...
    def GetYAxisInfo(self, _: DataUnit, __: DataValueType) -> None: ...
...
class IMSScanRecord:
    ...
    @property
    def IsFragmentorVoltageDynamic(self): ...
...
class IMsdrChargeStateAssignmentFilter:
    ...
    @property
    def LimitMaxChargeState(self): ...

    @LimitMaxChargeState.setter
    def LimitMaxChargeState(self): ...

    @property
    def MaximumChargeState(self): ...
    ...
    @property
    def RequirePeptideLikeAbundanceProfile(self): ...
